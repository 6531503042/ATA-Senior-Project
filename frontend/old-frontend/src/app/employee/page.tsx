    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-500 mt-2">
          Here are your feedback requests that need attention.
        </p>
      </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="p-3 bg-violet-50 rounded-lg group-hover:bg-violet-100/80 transition-colors">
                      ...
                      <div className="mt-2">
                        ...
                        <p className="text-xs text-violet-600">
                          {feedback.validationRules.requiresComments
                            ? "Comments required"
                            : "Optional comments"}
                        </p>
                      </div>
                    ...
                    <div className="p-3 bg-violet-50 rounded-lg group-hover:bg-violet-100/80 transition-colors">
                      ...
                      <div className="mt-2">
                        ...
                        <p className="text-xs text-violet-600">
                          {format(new Date(feedback.startDate), "MMM d")} -{" "}
                          {format(new Date(feedback.endDate), "MMM d")}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {!feedback.alreadySubmitted && feedback.active && (
                      <Button
                        ...
                        className="bg-violet-600 hover:bg-violet-300 text-white"
                      >
                        {isSubmitting ? (
                          <>
