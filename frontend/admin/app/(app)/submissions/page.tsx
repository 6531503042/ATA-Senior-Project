...
export default function SubmissionsPage() {
  ...
  const sentimentCounts = useMemo(() => {
    ...
    const init = { positive: 0, neutral: 0, negative: 0 } as Record<string, number>;
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          <FeedbackSelector options={feedbackOptions} value={selectedFeedbackId} onChange={setSelectedFeedbackId as (v: string) => void} />
        </div>
      </div>
      ...
      {loading ? (
        ...
        <>
          <SubmissionMetrics total={stats.total} analyzed={stats.analyzed} pending={stats.pending} />

          <Tabs aria-label="Submissions Tabs" variant="underlined" color="primary">
            <Tab key="overview" title="Overview">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div className="lg:col-span-1">
                  <SatisfactionOverview satisfactionRate={satisfactionRate} totalSubmissions={allItems.length} />
                </div>
              </div>
            ...
            <Tab key="submissions" title="Submissions">
              <div className="rounded-xl bg-white dark:bg-default-50 p-3 sm:p-4 shadow-lg">
                <SubmissionTable items={items} loading={loading} onEdit={() => {}} onDelete={() => {}} />
                <BottomContent
      ...
      <SubmissionsDetailModal isOpen={!!detail} onClose={() => setDetail(null)} item={detail} />
