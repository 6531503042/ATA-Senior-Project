...
export function DashboardChart({ data }: DashboardChartProps) {
  ...
  const avgSubmissions = Math.round(
    totalSubmissions / data.datasets[1].data.length,
  );
            ...
            <div className="mt-6 pt-6 border-t border-default-200">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="flex flex-wrap justify-center sm:justify-start gap-6">
                  <div className="flex items-center gap-3">
                    <div className="w-4 h-4 bg-gradient-to-r from-blue-500 to-blue-300 rounded shadow-sm" />
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-4 h-4 bg-gradient-to-r from-green-500 to-green-300 rounded shadow-sm" />
                    <span className="text-sm font-medium text-default-700">
