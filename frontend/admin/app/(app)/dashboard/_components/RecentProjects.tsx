...
import { Card, CardBody, CardHeader, Avatar, Progress, Chip, Skeleton } from '@heroui/react';
  ...
  return (
    <div className="space-y-3">
      {projects.slice(0, 5).map((project, index) => (
        <div key={project.id || index} className="flex items-start gap-3 p-3 rounded-lg border border-default-200 hover:bg-default-50 transition-colors">
          <Avatar 
            size="sm" 
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="space-y-1">
              <div className="flex items-center justify-between text-xs">
                ...
                <span className="text-default-700 font-medium">{project.progress}%</span>
              </div>
              <Progress 
                size="sm" 
