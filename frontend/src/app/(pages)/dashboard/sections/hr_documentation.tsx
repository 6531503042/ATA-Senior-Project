    ...
    <div className="p-5 flex flex-col w-full h-auto">
      ...
      <div className="w-full h-auto rounded-b-xl border border-t-0 py-5 px-8 flex flex-col shadow-lg">
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10">
          ...
          <div className="flex flex-col gap-4 p-5 bg-violet-50 rounded-lg justify-between hover:scale-105 transition-all duration-500 shadow-lg">
            <h1 className="font-semibold text-base text-violet-700 flex flex-row items-center gap-2"><Calendar className="w-6 h-6"/>Talent Management</h1>
            <span className="font-thin text-sm text-zinc-600">Employee development and succession planning</span>
            <button className="flex flex-row w-full justify-center items-center gap-3 rounded-lg bg-black p-2 text-white hover:shadow-lg duration-300">Generate Summary<Download className="h-4 w-4" /></button>
          </div>
          <div className="flex flex-col gap-4 p-5 bg-violet-50 rounded-lg justify-between hover:scale-105 transition-all duration-500 shadow-lg">
            <h1 className="font-semibold text-base text-violet-700 flex flex-row items-center gap-2"><Calendar className="w-6 h-6"/>Compliance Report</h1>
            <span className="font-thin text-sm text-zinc-600">Regulatory compliance and policy adherence summary</span>
            <button className="flex flex-row w-full justify-center items-center gap-3 rounded-lg bg-black p-2 text-white hover:shadow-lg duration-300">Generate Summary<Download className="h-4 w-4" /></button>
          </div>
          <div className="flex flex-col gap-4 p-5 bg-violet-50 rounded-lg justify-between hover:scale-105 transition-all duration-500 shadow-lg">
            <h1 className="font-semibold text-base text-violet-700 flex flex-row items-center gap-2"><Calendar className="w-6 h-6"/>Recognition & Awards</h1>
            <span className="font-thin text-sm text-zinc-600">Employee recognition and achievements documentation</span>
            <button className="flex flex-row w-full justify-center items-center gap-3 rounded-lg bg-black p-2 text-white hover:shadow-lg duration-300">Generate Summary<Download className="h-4 w-4" /></button>
          </div>
        </div>
      </div>
