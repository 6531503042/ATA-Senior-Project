...
import { CheckIcon, ChevronDownIcon, UserIcon, X, UserPlus } from "lucide-react";
                ...
                <div className="flex items-center gap-2">
                  <div className="flex-1">
                    ...
                    {isOpen && (
                      ...
                      >
                        {users.length === 0 ? (
                          <div className="px-3 py-2 text-gray-500">No team members available</div>
                        ) : (
                          <>
                            <div className="px-3 py-2 text-gray-500 border-b border-b-black/5 text-xs uppercase font-medium">Select Team Member</div>
                            {users.map((user) => (
                              <div
                                key={user.id}
                                className={cn(
                                  "px-3 py-2 flex items-center cursor-pointer",
                                  user.id === member.userId ? "bg-violet-50 text-violet-900" : "hover:bg-gray-50"
                                )}
                                onClick={() => {
