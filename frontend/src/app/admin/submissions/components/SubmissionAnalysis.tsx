    ...
    <div className="space-y-6">
      ...
      <Card className="bg-gradient-to-br from-violet-50 to-fuchsia-50 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              {analysis.executive_summary.strengths.map((strength, index) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm text-emerald-800">{strength.description}</p>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h4 className="text-base font-medium text-gray-900">Areas for Improvement</h4>
            </div>
            <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        {analysis.question_analyses.map(qa => {
                          if (qa.category === weakness.category && qa.improvement_priorities.length > 0) {
                            return (
                              <div key={qa.question_id} className="mt-3 space-y-2">
                                <p className="text-sm font-medium text-red-700">Suggested Improvements:</p>
                                {qa.improvement_priorities.map((priority, pIndex) => (
                                  <div key={pIndex} className="flex items-center gap-2 bg-white/50 p-2 rounded-lg">
                                    <Badge className={cn(
                                      priority.priority.toLowerCase() === 'high' ? "bg-red-100 text-red-700" :
                                      priority.priority.toLowerCase() === 'medium' ? "bg-amber-100 text-amber-700" :
                                      "bg-emerald-100 text-emerald-700"
                                    )}>
                                      {priority.priority}
                                    </Badge>
                                    <span className="text-sm text-gray-700">{priority.description}</span>
                                  </div>
                                ))}
                              </div>
                            );
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h4 className="text-base font-medium text-gray-900">Action Items</h4>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <HoverCard>
                    <HoverCardTrigger asChild>
                      <div className={cn(
                        ...
                        item.priority === 'High' ? "hover:border-red-200" :
                        item.priority === 'Medium' ? "hover:border-yellow-200" :
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex flex-wrap gap-2">
                              ...
                              <Badge className={cn(
                                ...
                                item.priority === 'High' ? "text-red-700 border-red-200" :
                                item.priority === 'Medium' ? "text-yellow-700 border-yellow-200" :
                    ...
                    <HoverCardContent className="w-96 bg-white p-4">
                      <div className="space-y-3">
                        <h4 className="text-sm font-medium text-gray-900">Action Item Details</h4>
                        {itemData.details && itemData.details.length > 0 && (
                          <div className="space-y-2">
                            ...
                            <ul className="list-disc list-inside text-xs space-y-1.5">
                              {itemData.details.map((detail: string, i: number) => (
        ...
        {analysis.executive_summary.key_insights.length > 0 && (
          <div className="mt-8 pt-6 border-t space-y-4">
            <div className="flex items-center gap-2">
              ...
              <h4 className="text-base font-medium text-gray-900">Key Insights</h4>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div className="mt-8 space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-base font-medium text-gray-900">Category Analysis</h4>
        </div>
            ...
            >
              <div className="relative p-4 bg-white rounded-lg border border-indigo-100 shadow-sm transition-all duration-200 hover:shadow-lg hover:border-indigo-300">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <Badge className={cn(
                    "px-2 py-1 shadow-sm",
                    data.sentiment === 'POSITIVE' ? "bg-emerald-100 text-emerald-700 border border-emerald-200" :
                    data.sentiment === 'NEGATIVE' ? "bg-red-100 text-red-700 border border-red-200" :
                          ...
                          <HoverCard key={index}>
                            ...
                            <HoverCardContent className="w-80 bg-white p-4">
                              <div className="space-y-2">
                                ...
                                {recData.details && recData.details.length > 0 && (
                                  <div className="mt-2 space-y-1">
                                    {recData.details.map((detail: string, i: number) => (
      ...
      <div className="mt-8 space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h4 className="text-base font-medium text-gray-900">Improvement Areas</h4>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h5 className="text-sm font-medium text-gray-900 mb-2">
                      {area.category.split('_').map(word => word.charAt(0).toUpperCase() + word.slice(1).toLowerCase()).join(' ')}
                    </h5>
                    <div className="mb-3">
                      <div className="flex items-center justify-between text-sm mb-1">
                        ...
                        try {
                          ...
                          return (
                            <HoverCard key={recIndex}>
                              ...
                              <HoverCardContent className="w-80 bg-white p-4">
                                <div className="space-y-2">
                                  <h4 className="text-sm font-medium text-gray-900">Improvement Details</h4>
                                  {recData.details && (
                                    <div className="mt-2 space-y-1">
                                      {recData.details.map((detail: string, i: number) => (
                                        <p key={i} className="text-xs text-gray-600">
                          ...
                          console.error('Failed to parse area recommendation:', error);
                          return null;
                        }
                      })}
                    </div>
      ...
      {analysis.overall_priorities.length > 0 && (
        <div className="mt-8 space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h4 className="text-base font-medium text-gray-900">Overall Priorities</h4>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
