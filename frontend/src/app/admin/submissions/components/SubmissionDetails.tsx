      ...
      case "SENTIMENT":
        ...
        return (
          <div className="flex items-center gap-2 mt-2">
            <Badge
              className={cn(
                sentimentColors[response as keyof typeof sentimentColors] ||
                  sentimentColors.NEUTRAL,
                "text-base",
              )}
            >
              {sentimentEmojis[response as keyof typeof sentimentEmojis]}{" "}
              {response}
            </Badge>
          </div>
        );
                    ...
                    className={cn(
                      ...
                      (() => {
                        const normalizedScore =
                          normalizeScore(analysis.score) / 100;
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-6">
              <div className="p-4 md:p-5 bg-gradient-to-br from-blue-50 to-blue-100/30 rounded-xl shadow-sm border border-blue-100">
                ...
                <div className="text-2xl md:text-3xl font-bold text-blue-900 flex items-baseline gap-2">
                  ...
                  <span className="text-xs md:text-sm font-normal text-blue-600">
                    confidence
                  </span>
                </div>
                <Progress
                  ...
                  className={cn(
                    ...
                    (() => {
                      const normalizedScore =
                        normalizeScore(analysis.overall_score) / 100;
                      if (normalizedScore >= 0.8) return "bg-green-100";
                      if (normalizedScore >= 0.6) return "bg-yellow-100";
                      return "bg-red-100";
                    })(),
              ...
              <div className="p-4 md:p-5 bg-gradient-to-br from-violet-50 to-violet-100/30 rounded-xl shadow-sm border border-violet-100">
                <div className="text-sm text-violet-700 mb-1 font-medium">
                  Response Quality
                </div>
                <div className="text-2xl md:text-3xl font-bold text-violet-900 flex items-baseline gap-2">
                  ...
                  <span className="text-xs md:text-sm font-normal text-violet-600">
                    score
                  </span>
                </div>
                <Progress
                  ...
                  className={cn(
                    ...
                    (() => {
                      const normalizedScore =
                        normalizeScore(analysis.key_metrics.response_quality) /
                        100;
                      if (normalizedScore >= 0.8) return "bg-green-100";
                      if (normalizedScore >= 0.6) return "bg-yellow-100";
                      return "bg-red-100";
              ...
              <div className="p-4 md:p-5 bg-gradient-to-br from-emerald-50 to-emerald-100/30 rounded-xl shadow-sm border border-emerald-100 sm:col-span-2 md:col-span-1">
                ...
                <div className="text-2xl md:text-3xl font-bold text-emerald-900 flex items-baseline gap-2">
                  ...
                  <span className="text-xs md:text-sm font-normal text-emerald-600">
                    positive
                  </span>
                </div>
                <Progress
                  ...
                  className={cn(
                    ...
                    (() => {
                      const normalizedScore =
                        normalizeScore(analysis.key_metrics.sentiment_score) /
                        100;
                      if (normalizedScore >= 0.8) return "bg-green-100";
                      if (normalizedScore >= 0.6) return "bg-yellow-100";
                      return "bg-red-100";
