...
import { Users, BarChart2, CheckCircle2, MessageSquare } from "lucide-react";
    ...
    const fetchData = async () => {
      try {
        ...
        const [insightsRes, usersRes] = await Promise.all([
          axios.get(
            `http://localhost:8085/api/analysis/insights/${feedbackId}`,
          ),
          submittedBy
            ? axios.get<User[]>("http://localhost:8081/api/manager/list", {
                headers: {
