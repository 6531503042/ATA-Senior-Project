  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-violet-600 text-white hover:bg-violet-600 hover:text-white focus:bg-violet-600 focus:text-white dark:bg-violet-600 dark:text-white dark:hover:bg-violet-600 dark:hover:text-white dark:focus:bg-violet-600 dark:focus:text-white",
