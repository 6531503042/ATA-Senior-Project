...
import type { Question } from '@/app/types/employee';
...
import type { Privacy, FeedbackSubmissionPayload } from '@/app/types/employee';
...
function adaptToQuestion(q: FeedbackQuestion): Question {
  return {
    ...
    content: q.text, // required by your Question type
    required: q.required,
    type: q.type, // same union
    category: 'general', // default
    answerType: mapAnswerType(q.type), // required by your Question type
    answers: q.answers ?? [], // ensure array
    description: q.description ?? '', // must be string (not undefined)
    validationRules: null, // or provide real rules if you have them
  };
}
